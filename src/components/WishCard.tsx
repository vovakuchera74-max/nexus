...
const Add = useCartStore((state)=>state.addItem)
    ...
    return(
        <div className={`${s.Card} ${inter.className}`}>
            <div className={s.Cartimg}><img src={wish.image_url} alt="" /> </div>
            <div className={s.InfoBlock}>
                ...
                <div className={s.info}>
                    ...
                    <div className={s.btnpls}>
                        ...
                        <button className={s.Addbtn} onClick={()=>Add(wish)}><ShoppingCart size={12}/> <span>Add</span></button>
                        <button className={s.basket} onClick={()=>removeWish(wish.id)}><X size={15}/></button>
